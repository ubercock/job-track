...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // Darker overlay + blur = separation + readability
      "fixed inset-0 z-50 bg-white/35 backdrop-blur-sm",
      // subtle open/close animation (lightweight)
